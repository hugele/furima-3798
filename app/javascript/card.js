const pay = () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const card = {
      number: formData.get("credit_card_address[number]"),
      cvc: formData.get("credit_card_address[cvc]"),
      exp_month: formData.get("credit_card_address[exp_month]"),
      exp_year: `20${formData.get("credit_card_address[exp_year]")}`,
    };
